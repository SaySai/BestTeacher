...
public class HaojiajiaoApplication extends Application {
    ...
    public static String userName = null; //mail-box address
    ...
    public static boolean ifIsSignUp = false;
    public static ArrayList<UserList> UserList = null;

    public static String R_userName = null; //userName for RongCloud
    public static String R_name = null; //name for RongCloud
    public static String R_picUrl = null; //picUrl for RongCloud
