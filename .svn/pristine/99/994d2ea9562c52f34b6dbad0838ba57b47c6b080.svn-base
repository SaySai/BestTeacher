...
public class EmptyLayout {
	...
	private void changeEmptyType() {
		...
		if (!mViewsAdded) {
			...
			RelativeLayout rl = (RelativeLayout)inflater.inflate(R.layout.empty_layout, null);
...
//						}
//					}
					((ImageView)loadingAnimationView).setImageResource(R.drawable.loading_animation);
					animationDrawable = (AnimationDrawable) ((ImageView)loadingAnimationView).getDrawable();
...
//			}
	 ...
	 */
	public EmptyLayout(Context context, GridView mGridView) {
		mContext = context;
		mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		this.mGridView = mGridView;
	}
