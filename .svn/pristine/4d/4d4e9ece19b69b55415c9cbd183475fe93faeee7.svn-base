 ...
 *******************************************************************************/
package com.shanghai.haojiajiao.weight.log;

/**
 * interface for a logger iv_class to replace the static calls to {@link android.util.Log}
 */
public interface Logger {
     ...
     *            the iv_class or activity where the log call occurs.
