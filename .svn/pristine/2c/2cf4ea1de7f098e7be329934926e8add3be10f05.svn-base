 ...
 *******************************************************************************/
package com.shanghai.haojiajiao.weight.library;
...
import com.shanghai.haojiajiao.weight.library.internal.FlipLoadingLayout;
import com.shanghai.haojiajiao.weight.library.internal.LoadingLayout;
import com.shanghai.haojiajiao.weight.library.internal.RotateLoadingLayout;
import com.shanghai.haojiajiao.weight.library.internal.Utils;
import com.shanghai.haojiajiao.weight.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * method and return an instance of your custom iv_class.
	 * <p/>
	 * Be sure to set the ID of the view in this method, especially if you're
	 * using a ListActivity or ListFragment.
	 * 
	 * @param context Context to create view with
	 * @param attrs AttributeSet from wrapped iv_class. Means that anything you
	...
	/**
	 * Implemented by derived iv_class to return whether the View is in a state
